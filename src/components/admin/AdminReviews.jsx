...
import { Star, Trash2, Search, RefreshCw, MessageSquare, CheckCircle2, ChevronLeft, ChevronRight, User, Eye } from 'lucide-react';
...
const AdminReviews = () => {
  ...
  const handleDeleteReview = async (reviewId) => {
    if (!window.confirm('Are you sure you want to delete this review from database?')) {
      return;
    }
