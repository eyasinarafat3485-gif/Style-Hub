      ...
      <div className="bg-white rounded-2xl border border-gray-200/80 p-6 shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            Real-time accounts from MongoDB user collection and role permissions
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-4 sm:p-5 rounded-2xl border border-gray-200/80 shadow-xs flex items-center justify-between">
          <div>
            ...
            <h3 className="text-2xl font-black text-slate-900 mt-1">{totalUsersCount}</h3>
            <span className="text-[10px] text-gray-500 font-medium">In MongoDB users</span>
          </div>
        ...
        <div className="bg-white p-4 sm:p-5 rounded-2xl border border-gray-200/80 shadow-xs flex items-center justify-between">
          <div>
            ...
            <h3 className="text-2xl font-black text-slate-900 mt-1">{adminCount}</h3>
            <span className="text-[10px] text-rose-500 font-medium">Privileged access</span>
          </div>
        ...
        <div className="bg-white p-4 sm:p-5 rounded-2xl border border-gray-200/80 shadow-xs flex items-center justify-between">
          <div>
            ...
            <h3 className="text-2xl font-black text-slate-900 mt-1">{customerCount}</h3>
            <span className="text-[10px] text-emerald-600 font-medium">Registered shoppers</span>
          </div>
        ...
        <div className="bg-white p-4 sm:p-5 rounded-2xl border border-gray-200/80 shadow-xs flex items-center justify-between">
          <div>
            ...
            <span className="text-[10px] text-gray-500 font-medium">Total registered orders</span>
          </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-200/80 shadow-xs overflow-hidden">
        {isLoading ? (
          <div className="py-16 text-center space-y-3">
            ...
            <p className="text-xs font-semibold text-gray-500">Connecting to MongoDB user collection...</p>
          </div>
          ...
          <div className="py-16 text-center space-y-3">
            ...
            <p className="text-xs text-gray-400 max-w-sm mx-auto">
              {searchTerm || roleFilter !== 'All'
                ...
                : 'Registered accounts will appear here automatically from MongoDB.'}
            </p>
          </div>
        ) : (
          <>
                    ...
                    return (
                      <tr key={cust._id} className="hover:bg-slate-50/70 transition-colors group">
                        ...
                        <td className="py-3.5 px-4 capitalize font-medium text-gray-600">
                          <span className="bg-slate-100 px-2 py-0.5 rounded-md text-[11px] font-semibold text-slate-700 border border-slate-200">
                ...
                return (
                  <div key={cust._id} className="p-4 space-y-3 bg-white hover:bg-slate-50/50 transition-colors">
                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span
                        className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-extrabold uppercase shrink-0 ${
                          cust.role === 'admin'
                            ? 'bg-rose-50 text-[#ff2056] border border-rose-200'
                            : 'bg-emerald-50 text-emerald-700 border border-emerald-200'
                        }`}
                    ...
                    <div className="grid grid-cols-3 gap-2 p-2.5 bg-slate-50 rounded-xl border border-slate-100 text-center text-[10px]">
                      <div>
                        ...
                        <span className="font-bold text-slate-700 capitalize">{cust.authProvider || 'Local'}</span>
                      </div>
                      <div>
