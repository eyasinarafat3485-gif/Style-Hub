...
//   const firstSlide = settings?.heroSlider?.[0] || DEFAULT_SITE_SETTINGS.heroSlider[0];

//   const badge = firstSlide?.badge || "New Season 2025 · Men's Premium Shirts";
//   const titleStart = firstSlide?.titleStart || "Style That Speaks ";
//   const titleHighlight = firstSlide?.titleHighlight || "CONFIDENCE.";
//   const subtitle = firstSlide?.subtitle || "Premium quality cotton shirts, tailored casuals & everyday menswear essentials crafted for comfort, breathability and timeless style.";
//   const primaryBtnText = firstSlide?.primaryBtnText || "Explore Shirts";
//   const primaryBtnLink = firstSlide?.primaryBtnLink || "/shop?category=Shirt";
//   const secondaryBtnText = firstSlide?.secondaryBtnText || "Men's Collection";
//   const secondaryBtnLink = firstSlide?.secondaryBtnLink || "/men";
...
//             <span className="text-[10px] sm:text-xs uppercase tracking-[0.2em] sm:tracking-[0.25em] font-bold text-rose-300 flex items-center gap-1.5">
...
//           {/* Main Headline */}
//           <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-[52px] font-bold text-white tracking-tight leading-[1.08] font-serif">
//             {titleStart} <br />
//             {titleHighlight && (
//               <span className="text-[#ff2056] bg-clip-text bg-gradient-to-r from-white via-rose-200 to-[#ff2056]">
//                 {titleHighlight}
//               </span>
//             )}
//           </h1>
...
//           {/* Subtitle Paragraphs */}
//           <div className="mt-2.5 sm:mt-4 space-y-1 sm:space-y-1.5 max-w-xl">
//             <p className="text-xs sm:text-sm lg:text-base text-gray-200/95 leading-relaxed font-medium">
//               {subtitle}
//             </p>
...
//               <Link
//                 to={primaryBtnLink}
//                 className="inline-flex items-center gap-2 px-5 sm:px-7 py-2.5 sm:py-3.5 bg-[#ff2056] hover:bg-[#e01648] text-white text-xs sm:text-sm uppercase tracking-wider font-extrabold rounded-xl shadow-xl shadow-rose-950/40 transition-all hover:scale-105 active:scale-95 group cursor-pointer"
//               >
...
//               <Link
//                 to={secondaryBtnLink}
//                 className="inline-flex items-center gap-2 px-5 sm:px-7 py-2.5 sm:py-3.5 bg-white/10 hover:bg-white/20 text-white text-xs sm:text-sm uppercase tracking-wider font-bold rounded-xl border border-white/30 backdrop-blur-md transition-all hover:scale-105 active:scale-95 cursor-pointer"
//               >
//                 {secondaryBtnText}
//               </Link>
//             )}
...
//           {/* Value Badges */}
//           <div className="flex flex-wrap items-center gap-3 sm:gap-5 mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-white/15 text-[10px] sm:text-xs text-gray-300">
